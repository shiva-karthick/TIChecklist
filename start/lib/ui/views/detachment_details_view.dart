...
import 'package:provider_architecture/ui/views/contents_drawer.dart';
...
class DetachmentDetailsView extends StatefulWidget {
  @override
  _DetachmentDetailsViewState createState() => _DetachmentDetailsViewState();
}

class _DetachmentDetailsViewState extends State<DetachmentDetailsView> {
  ...
  Widget build(BuildContext context) {
    return BaseView<VehicleModel>(
      ...
      builder: (context, model, child) => Scaffold(
        ...
        appBar: AppBar(
          title: Text('DetachmentDetailsView'),
          actions: <Widget>[
            IconButton(
